// PurePeptide neon motion ad — motion library. Dark "product launch" look (black, one neon accent derived
...
(function () {
  ...
  PP.neonCard = function (parent, o) {
    ...
    el.style.width = w + "px";
    el.style.height = h + "px";
    el.style.left = (o.x == null ? 540 : o.x) - w / 2 + "px";
    el.style.top = (o.y == null ? 960 : o.y) - h / 2 + "px";
